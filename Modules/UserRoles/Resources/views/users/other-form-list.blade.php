...
@section('title')
    <title> Other Forms | {{ config('app.name', 'Laravel') }}</title>
@stop
        ...
        <div class="row ">
            <div class="col-12  align-self-center">
                <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                    <div class="w-sm-100 mr-auto"><h4 class="mb-0">Other Form List</h4></div>
                    <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                        <li class="breadcrumb-item">Dashboard</li>
                        <li class="breadcrumb-item">Other Form List</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-sm-12 mt-3">
                <div class="card">
                    <div class="card-header  justify-content-between align-items-center">
                        <h4 class="card-title">Other Forms Legend</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 mt-3">
                <div class="card">
                    ...
                    <hr>
                    <!-- Other Filters ends -->
                    <form action="{{route('otherforms.index')}}" method="get" class="form-1 filter-form">
                    ...
                    <!-- ----------------------------- Form Two Starts ------------------------ -->
                    <form action="{{route('otherforms.index')}}" method="get" class="form-2 filter-form">
                        <div class="form-row" style="padding: 10px;">

...
@section('title')
    <title> Grading Status | {{ config('app.name', 'Laravel') }}</title>
@stop
            ...
            <div class="col-12  align-self-center">
                <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                    ...
                    <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                        ...
                        <li class="breadcrumb-item">Grading Status</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 mt-3">
                <div class="card">
                    ...
                    <form action="{{route('grading.status')}}" method="get" class="form-1 filter-form">
                        <div class="form-row" style="padding: 10px;">
                            ...
                            <div class="form-group col-md-2 mt-4">        
                               <!--  <button type="button" class="btn btn-primary reset-filter-1">Reset</button> -->
                                ...
                                <button type="button" data-url="{{ route('excel.grading-status') }}" class="btn btn-primary btn-lng form-1-adjudication">Export</button>
                            </div>
                    ...
                    <!-- ----------------- Form Two Starts ------------------------ -->
                    <form action="{{route('grading.status')}}" method="get" class="form-2 filter-form">
                        <div class="form-row" style="padding: 10px;">
                           ...
                           <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-2 mt-4">        
                                ...
                                <button type="button" data-url="{{ route('excel.grading-status2') }}" class="btn btn-primary btn-lng form-2-adjudication">Export</button>
                            </div>

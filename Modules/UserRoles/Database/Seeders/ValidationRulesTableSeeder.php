...
class ValidationRulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('validation_rules')->insert(array(
            0 =>
            array(
                'id' => '3079dd70-9106-4f08-8e77-4151jawad437',
                'rule' => 'equalTo',
                'title' => 'equalTo:value',
                'description' => 'The field under validation must be equal to the given value.',
                'rule_group' => 'Number',
                'is_active' => 1,
                'is_range' => 0,
                'num_params' => '1',
...
',
            ...
            57 =>
            array(
                'id' => '3079dd70-9106-4f08-8e77-491ejawad437',
                'rule' => 'lessThenOrEqual',
                'title' => 'lessThenOrEqual:value',
                'description' => 'The field under validation must be less than or equal to the given value.',
                'rule_group' => 'Number',
                'is_active' => 1,
                'is_range' => 0,
                'num_params' => '1',
            ...
            58 =>
            array(
                'id' => '3079dd70-9106-4f08-8e77-491jawad336',
                'rule' => 'lessThen',
                'title' => 'lessThen:value',
                'description' => 'The field under validation must be less than the given value.',
                'rule_group' => 'Number',
                'is_active' => 1,
                'is_range' => 0,
                'num_params' => '1',
            ...
            59 =>
            array(
                'id' => '3079dd70-9106-4f08-8e77-4jawad2b431',
                'rule' => 'greaterThanOrEqual',
                'title' => 'greaterThanOrEqual:value',
                'description' => 'The field under validation must be greater than or equal to the given value.',
                'rule_group' => 'Number',
                'is_active' => 1,
                'is_range' => 0,
                'num_params' => '1',
            ...
            60 =>
            array(
                'id' => '3079dd70-9106-4f08-8e77-jawad116b430',
                'rule' => 'greaterThan',

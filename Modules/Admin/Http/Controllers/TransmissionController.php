...
class TransmissionController extends Controller
{
    ...
    public function transmissionsStudyEdit(Request $request, $id)
    {
        ...
        $getSubjects = Subject::select('subjects.id', 'subjects.subject_id')
            ...
            ->get();
        // get all phases
        $getPhases = StudyStructure::select('study_structures.id', 'study_structures.name')->withOutRepeated()
        ...
        if ($getStudy != null) {
            ...
            $getStudyPhases = StudyStructure::where('study_id', $getStudy->id)->withOutRepeated()->pluck('id')->toArray();
            // fetch modalities
    ...
    public function transmissionStatus($findTransmission)
    {
        ...
        // get phase
        $getPhase = StudyStructure::where('study_id', $getStudy->id)->withOutRepeated()

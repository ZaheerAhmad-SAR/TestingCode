                    ...
                    <div class="scrollertodo">
                        <ul class="mail-app list-unstyled " id="steps-group">
                            ...
                            <li class="py-3 px-2 mail-item tab_{{$step_value->phase_id}}" style="@if ($key === 0) display: block;  @endif">
                                ...
                                <div class="d-flex align-self-center align-middle">
                                    <div class="mail-content d-md-flex w-100">
                                        <span class="mail-user">{{$step_value->step_name}}</span> 
                                      ...
                                      for(var i=0; i<len; i++){
                                        ...
                                        if(res['data'][i].phases.length != 0){
                                            ...
                                            tr_str += "<li class='py-3 px-2 mail-item tab_"+id+"' style='"+active+"'>"
                                                +'<input type="hidden" class="step_id" value="'+v.step_id+'"><input type="hidden" class="step_phase_id" value="'+v.phase_id+'"><input type="hidden" class="step_name" value="'+v.step_name+'"><input type="hidden" class="step_position" value="'+v.step_name+'"><input type="hidden" class="step_description" value="'+v.step_description+'"><input type="hidden" class="graders_number" value="'+v.graders_number+'"><input type="hidden" class="q_c" value="'+v.q_c+'"><input type="hidden" class="eligibility" value="'+v.eligibility+'">'
                                                +"<div class='d-flex align-self-center align-middle'><div class='mail-content d-md-flex w-100'><span class='mail-user'>"+v.step_name+"</span><p class='mail-subject'>"+v.step_description+".</p><div class='d-flex mt-3 mt-md-0 ml-auto'><div class='ml-md-auto mr-3 dot primary'></div><p class='ml-auto mail-date mb-0'>"+v.created_at+"</p><a class='ml-3' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'><i class='fas fa-cog'></i></a><div class='dropdown-menu p-0 m-0 dropdown-menu-right'><span class='dropdown-item edit_steps'><i class='far fa-edit'></i>&nbsp; Edit</span><span class='dropdown-item addsection'><i class='far fa-file-code'></i>&nbsp; Add Section</span><span class='dropdown-item'><i class='far fa-clone'></i>&nbsp; Clone</span><span class='dropdown-item deleteStep'><i class='far fa-trash-alt'></i>&nbsp; Delete</span></div></div></div></div>";
                                                tr_str  += "</li>";
                                            });
                                        }else{

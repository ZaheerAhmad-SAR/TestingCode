...
$adjudicationRequiredQuestionIdsArray = \Modules\Admin\Entities\QuestionAdjudicationRequired::getAdjudicationRequiredQuestionsArray($getAdjudicationRequiredQuestionIdsArray);
@endphp
<fieldset id="fieldset_adjudication_{{ $stepIdStr }}" class="">
    <div class="card p-2 mb-1">
        <input type="hidden" name="sectionId[]" value="{{ $section->id }}" />
            ...
            $finalAnswer = \Modules\Admin\Entities\FinalAnswer::getFinalAnswer($getFinalAnswerArray);
            ...
            <div class="form-group adjudication-border">
                ...
                <div class="row">
                    <div class="col-10">
                        <div class="row">
                            <div class="col-12">
                                @include('admin::forms.main_form_fields.main_form_field_checks', ['fieldType'=>$fieldType, 'question'=> $question, 'field_name'=> $field_name,
                ...
                <div class="col-{{$colNum}}">
                    ...
                    @include('admin::forms.adjudication_form_fields.adjudication_form_field_checks', ['fieldType'=>$fieldType, 'field_name'=> $grader_field_name, 'questionIdStr'=>

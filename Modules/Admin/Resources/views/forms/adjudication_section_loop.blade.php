@if (canAdjudication())
    <div class="all_step_sections adjudication_step_sections_{{ $stepIdStr }}"
        ...
        \Modules\Admin\Entities\AdjudicationFormStatus::getAdjudicationFormStatusObj($getAdjudicationFormStatusArray);
                                ...
                                <div class="tab-content">
                                    ...
                                    @foreach ($sections as $key => $section)
                                        ...
                                        <div class="tab-pane fade {{ $firstSection ? 'first_tab_' . $stepIdStr : '' }} {{ $firstSection ? 'active show' : '' }}"
                                            ...
                                            @include('admin::forms.adjudication_section_questions', $sharedData )
                                            @include('admin::forms.adjudication_section_next_previous', $sharedData)
                                        </div>
                                        @php
                                        $firstSection = false;
                                        @endphp

        ...
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 mr-auto">
                    <h4 class="mb-0">Phase: {{$phase->name}}</h4>
                </div>
                        ...
                        <div class="row p-3">
                            <ul class="col-sm-3 nav nav-tabs d-block d-sm-flex mb-4">
                                ...
                                <li class="nav-item  mb-4 col-sm-12">
                                    <a class="nav-link p-0 {{ ($firstStep) ? 'active' : '' }}" data-toggle="tab"
                                        href="#tab{{$step->step_id}}">
                                        <div class="d-flex text-white">
                                            <div class="mr-3 mb-0 h1">{{$step->step_position}}</div>
                                            <div class="media-body align-self-center">
                                                <h6 class="mb-0 text-uppercase font-weight-bold">{{$step->step_name}}
                                                </h6>
...
.form-control-ocap, .form-control-ocap:focus, .form-control-ocap:disabled, .form-control-ocap[readonly] {
...
.form-control-ocap, .form-control-ocap:focus, .btn-primary:not(:disabled):not(.disabled).active:focus, .btn-primary:not(:disabled):not(.disabled):active:focus, .show > .btn-primary.dropdown-toggle:focus,

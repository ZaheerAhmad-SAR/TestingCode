...
class DevicesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $devices = $devices->groupBy('certify_device.device_categ')->groupBy('certify_device.device_sn')->groupBy('certify_device.study_name')->groupBy('certify_device.site_id')->where('certify_device.study_id', session('study_code'))->toSql();
       // dd($devices);

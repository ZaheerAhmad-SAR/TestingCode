...
class PhotographersControllers extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $photographers = $photographers->groupBy('photographer_name')->groupBy('study_name')->where('photographer_data.study_id', session('study_code'))->paginate(\Auth::user()->user_prefrences->default_pagination);

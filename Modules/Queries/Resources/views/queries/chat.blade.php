...
{{--                                                </li>--}}
{{--                                                <li class="nav-item">--}}
{{--                                                    <a class="nav-link font-weight-bold" id="tabs-week-tab" data-toggle="tab" href="#tabs-week" role="tab" aria-controls="tabs-week" aria-selected="false">Queries</a>--}}
{{--                                                </li>--}}
{{--                                            </ul>--}}
...
{{--                                                    <li class="nav-item active px-3">--}}
{{--                                                        <a class="nav-link" data-toggle="tab" href="#tab1-{{$query->id}}" role="tab" aria-selected="true">--}}
{{--                                                            <div class="media d-block d-flex text-left py-3">--}}
{{--                                                                <div class="media-body align-self-center mt-0">--}}
{{--                                                                    <b class="mb-1 font-weight-bold">{{strip_tags($query->messages)}}</b><br>--}}
{{--                                                                </div>--}}
{{--                                                            </div>--}}
{{--                                                        </a>--}}
{{--                                                    </li>--}}

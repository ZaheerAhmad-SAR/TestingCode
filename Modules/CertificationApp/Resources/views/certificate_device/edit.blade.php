                        ...
                        <form action="{{ route('certification-device.update', encrypt($findTransmission->id))}}" method="POST" class="transmission-form">
                            ...
                            <div class="row">
                              ...
                              <!--//////////////// row  ///////////////////////// -->
                                ...
                                <button class="btn btn-primary" style="margin-top: 10px" onclick="transmissionDevice('{{$findTransmission->Device_Model}}', '{{$findTransmission->Device_manufacturer}}')">Add Device</button>
                                </div>
...
<script type="text/javascript">
    ...
    /********************* add new device ***********************/
    function transmissionDevice(deviceModel, deviceManufacturer) {
        // hide error message
        ...
        $('input[name="device_manufacturer"]').val(deviceManufacturer);
